...
sc text01.txt abc   (Get-Alias sc -> Set-Content/Adds a line of text 'abc' into the named file.
                     NOTE: If the content contains spaces...; then, it's necessary to surround the data using a pair of quote marks: "a b c", instead.
...
dir                 (Get-Alias dir -> Get-ChildItem/Shows what is the current folder DIRectory listing/including the size of all files)
